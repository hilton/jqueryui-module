...
This module provides working examples of "jQuery UI":http://jqueryui.com/ widgets, integrated with a Play appliction. This module includes code samples for several widgets:
